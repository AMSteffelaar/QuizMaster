...
INSERT INTO `quizmaster`.`question` (`Quiz_idQuiz`, `question`, `answerA`, `answerB`, `answerC`, `answerD`) VALUES ('1', 'Wat is een crachpad?', 'Een mat die wordt gebruikt om onder de klimmer te leggen zodat een val wordt verzacht', 'Een mat voor een crashtestdummy', 'een koffiepad', 'Ik weet het niet');
...
INSERT INTO `quizmaster`.`questioncourse` (`Quiz_idQuiz`, `question`, `answerA`, `answerB`, `answerC`, `answerD`) VALUES ('4', 'Waarom beklimmen klimmers bergen?', 'Omdat ze er zijn', 'Daarvoor is geen enkele reden', 'Zolang er bergen zijn willen mensen klimmen', 'Om thuis mooie verhalen te kunnen vertellen');
